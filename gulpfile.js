var gulp            = require('gulp'),
    ...
    gulp.task('fonts', () => {
       return gulp.src('app/libs/slick-carousel/slick/fonts/*')
    ...
    gulp.task('minJS', () => {
        return gulp.src(['app/libs/jquery/dist/jquery.min.js', 'app/libs/what-input/dist/what-input.min.js', 'app/libs/foundation-sites/dist/js/foundation.min.js', 'app/libs/slick-carousel/slick/slick.min.js'])
            .pipe(filesize())
